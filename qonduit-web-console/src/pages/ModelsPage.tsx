            ...
            {models.map((model) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <svg style={{ width: '8px', height: '8px' }} className="text-[var(--text-secondary)] opacity-0 group-hover:opacity-50 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
