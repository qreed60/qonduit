            ...
            {models.map((model) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <svg style={{ width: '16px', height: '16px' }} className="text-[var(--text-secondary)] opacity-0 group-hover:opacity-50 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
